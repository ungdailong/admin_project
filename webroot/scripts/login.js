...
}]), angular.module("minovateApp").controller("MailCtrl", ["$scope", function() {
}]), angular.module("minovateApp").controller("LoginCtrl", ["$scope", "$http", function(a,b) {
    a.formData = {};
    a.login = function() {
        a.formData = {
        ...
        b({
            method  : 'POST',
            url     : 'users/login',
            data    : $.param(a.formData),  // pass in data as strings
